...
export default function ContactForm({ messages }) {
  ...
  function handleCopy(e, key, value) {
    e.preventDefault();
    const rect = e.currentTarget.getBoundingClientRect();
    navigator.clipboard.writeText(value).then(() => {
      setPopover({
        id: Date.now(),
        message: t(`footer.${key}Copied`, "Copied!"),
        description: value,
        ...
        <div className="space-y-6">
          {t("contact.address") && (
            <div
              ...
              onClick={(e) => handleCopy(e, "address", t("contact.address"))}
            >
              <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0 group-hover:bg-primary/20 group-hover:scale-110 transition-all duration-300">
              ...
              <div className="transition-colors">
                <div className="flex items-center gap-2">
                  ...
                  <i className="fas fa-copy text-sm text-muted-foreground group-hover:text-primary opacity-0 group-hover:opacity-100 transition-all duration-300 ml-auto"></i>
                </div>
          ...
          <div
            className="flex items-start gap-4 cursor-pointer group"
            onClick={(e) => handleCopy(e, "email", t("contact.emailAddress"))}
          >
            <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0 group-hover:bg-primary/20 group-hover:scale-110 transition-all duration-300">
            ...
            <div className="transition-colors">
              <div className="flex items-center gap-2">
                ...
                <i className="fas fa-copy text-sm text-muted-foreground group-hover:text-primary opacity-0 group-hover:opacity-100 transition-all duration-300"></i>
              </div>
              <p className="text-muted-foreground group-hover:text-muted-foreground transition-colors">
                {t("contact.emailAddress", "info@starelectronic.sk")}
              </p>
            </div>
          </div>
          ...
          <div
            className="flex items-start gap-4 cursor-pointer group"
            onClick={(e) => handleCopy(e, "phone", t("contact.phoneNumber"))}
          >
            <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0 group-hover:bg-primary/20 group-hover:scale-110 transition-all duration-300">
            ...
            <div className="transition-colors">
              ...
              <p className="text-muted-foreground group-hover:text-muted-foreground transition-colors">
                {t("contact.phoneNumber", "+421 905 423 372")}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="lg:hidden mb-8">
        ...
        <div className="flex flex-col gap-4 mb-8">
          <div
            onClick={(e) =>
              handleCopy(
                e,
                "phone",
                t("contact.phoneNumber", "+1 (555) 123-4567"),
              )
            }
            className="flex items-center gap-4 bg-muted/30 p-4 rounded-2xl active:bg-primary/10 lg:hover:bg-primary/5 lg:hover:-translate-y-1 transition-all cursor-pointer duration-300 group"
          >
            <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary text-xl shrink-0 lg:group-hover:bg-primary/20 lg:group-hover:scale-110 transition-all duration-300">
          ...
          <div
            onClick={(e) =>
              handleCopy(
                e,
                "email",
                t("contact.emailAddress", "info@star-electronic.example"),
              )
            }
            className="flex items-center gap-4 bg-muted/30 p-4 rounded-2xl active:bg-primary/10 lg:hover:bg-primary/5 lg:hover:-translate-y-1 transition-all cursor-pointer duration-300 group"
          >
          ...
          <div
            ...
            className="flex items-center gap-4 bg-muted/30 p-4 rounded-2xl cursor-pointer lg:hover:bg-primary/5 lg:hover:-translate-y-1 active:bg-primary/10 transition-all duration-300 group"
          >
            <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary text-xl shrink-0 lg:group-hover:bg-primary/20 lg:group-hover:scale-110 transition-all duration-300">
